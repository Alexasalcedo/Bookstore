...
<nav class="bg-164D2C shadow dark:bg-gray-800" style="background-color: #164D2C;">
    <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <a href="/book" class="text-white transition-colors duration-300 transform border-b-2 border-blue-500 mx-1.5 sm:mx-6"> Inicio &emsp; </a>

        <a href="/book/create" class="text-white border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"> Crear &emsp; </a>

        <a href="/category" class="text-white border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"> Categoria &emsp; </a>

        <a href="/comment" class="text-white border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"> Blog &emsp; </a>
