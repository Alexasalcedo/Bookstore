...
<nav class="bg-164D2C shadow dark:bg-gray-800" style="background-color: #164D2C;">
    <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        ...
        <a href="#" class="text-white border-b-2 border-transparent hover:text-gray-800 transition-colors duration-300 transform dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6"> blog &emsp; </a>
